...
| Usage | Session %, Weekly %, Scoped weekly %, Auto %, Usage bar | Window percentage or a compact three-glyph usage bar. For Codex with multiple accounts, Weekly % and Auto % show every account's weekly percentage. |
